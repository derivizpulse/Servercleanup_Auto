...
export const initialDatabases: DatabaseRow[] = [
  ...
  row("db-1",  "WholeDentalWellness_C1",        "Aquila-1",  "Build VM",  12.3, "Delete",          "Trigger 1", "SB/ITL Completed",   d(-5),  d(0),   5, true),
  // ── Expires tomorrow (Day 4 of 5) ──
  row("db-2",  "SmileBright_C2",                "Aquila-1",  "Build VM",  8.7,  "Delete",          "Trigger 1", "SB/ITL Completed",  d(-4),  d(1),   5, true),
  ...
  // ── Excluded ──
  row("db-7",  "CarePlusOrtho_C1",              "Aquila-3",  "Build VM",  18,   "Retain",          "None",      null,                 d(-5),  null,   null, true),
  row("db-8",  "CarePlusOrtho_C1_LIVE",         "Aquila-1",  "Aquila",    25,   "Retain",          "None",      null,                 d(-36), null,   null, false),
  row("db-9",  "NorthBridgeDental_C3_LIVE",     "Raven-1",   "Raven",     12.4, "Retain",          "None",      null,                 d(-84), null,   null, false),
  // ── Active / No action ──
  ...
  row("db-16", "WholeDentalWellness_C1_SB",     "SB-1",      "SB",        40,   "Scheduled Delete","Trigger 1", "SB/ITL Completed",   d(-3),  d(7),   7,  false),
  row("db-17", "WholeDentalWellness_C1_SB_2",    "SB-2",      "SB",        28,   "Scheduled Delete","Trigger 1", "SB/ITL Completed",   d(-3),  d(7),   7,  false),
  row("db-18", "WholeDentalWellness_C1_ITL",    "ITL-1",     "ITL",       19,   "Scheduled Delete","Trigger 1", "SB/ITL Completed",   d(-96), d(7),   7,  false),
];
